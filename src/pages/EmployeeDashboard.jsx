            ...
            <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
              ...
              <div className="flex items-center gap-2.5 bg-gradient-to-r from-slate-50 via-white to-orange-50/30 pl-1.5 pr-3 py-1 rounded-2xl border border-slate-200/80 shadow-2xs hover:border-orange-200 transition group">
                <div className="relative">
                  ...
                  <span className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-emerald-500 ring-2 ring-white" title="Active Specialist" />
                </div>
                <div className="text-left">
                  <div className="flex items-center gap-1">
                    ...
                    <i className="ri-verified-badge-fill text-orange-600 text-[11px]" title="Operations Executive" />
                  </div>
                  <span className="text-[9.5px] text-slate-400 font-bold block leading-none mt-0.5">
                    Operations Desk • Onboarding
                  </span>
                </div>
              </div>
            ...
            {view === 'add' && (
              <form onSubmit={handleSaveListing} className="space-y-4 w-full pb-10">
                ...
                <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200/90 shadow-2xs space-y-4">
                  ...
                  {/* Floor Position Selection & Custom Floor */}
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] text-slate-400 font-medium">Standard Delhi NCR Positions</span>
                    </div>
